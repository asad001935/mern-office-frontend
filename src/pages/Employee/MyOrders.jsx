...
export default function MyOrders() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-950 dark:text-white">My orders</h2>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">All orders you have created, newest first.</p>
      </div>
      ...
      <div className="grid gap-4">
        ...
        {loading && <div className="rounded-lg border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">Loading orders...</div>}
      </div>
    </div>
  );
}
